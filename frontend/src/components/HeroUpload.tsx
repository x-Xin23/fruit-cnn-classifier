  ...
  return (
    <div className="w-full max-w-4xl mx-auto flex flex-col items-center my-auto pb-8">
      ...
      <motion.div
        ...
        className={`w-full max-w-2xl aspect-[16/9] md:aspect-[21/9] rounded-[2rem] border-2 border-dashed cursor-pointer flex flex-col items-center justify-center p-8 transition-all duration-500 shadow-sm ${
          isDragging 
